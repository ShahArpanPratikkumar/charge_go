...
ChargeGo is a full-stack web application that solves the real-world problem of mobile battery drain.It allows users to find nearby stations, scan QR codes, rent powerbanks, and manage transactions easily.
...
✨ Secure Authentication📍 Nearby Station Finder (Map)🔋 QR Code Based Rental💳 Wallet System📊 Dashboard & Activity📱 Fully Responsive UI
...
Get kiosk details + slot availability
...
Return powerbank (kioskId, slotId)
...
Billed per hour, max ₹80/day

Deposit

₹200

Refunded on successful return

Lost/Damaged

₹500

Charged if powerbank not returned within 48 hrs
...
People often run out of battery while traveling.ChargeGo provides a smart, scalable solution like bike-sharing for powerbanks.

🚀 Future Enhancements

✨ Real-time tracking✨ Payment gateway✨ Smart station updates✨ Admin dashboard
